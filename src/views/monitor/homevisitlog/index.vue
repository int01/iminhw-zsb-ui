        ...
        <el-row>
          ...
          <el-col :span="12">
            ...
            <el-form-item label="请求地址："
              >{{ form.requestMethod }} {{ form.visitUrl }}</el-form-item
            >
          </el-col>
          <el-col :span="24">
...
function handleDelete(row) {
  ...
  proxy.$modal
    .confirm('是否确认删除日志编号为"' + visitIds + '"的数据项?')
    .then(function () {
