<template>
   <div class="app-container">
      ...
      <el-table ref="operlogRef" v-loading="loading" :data="operlogList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
         ...
         <el-table-column label="日志编号"  sortable="custom" align="center" prop="operId" />
         ...
         <el-table-column label="主机"  sortable="custom" align="center" prop="operIp" width="130" :show-overflow-tooltip="true" />
